        ...
        <View style={styles.imageGrid}>
          <View style={styles.imageRow}>
            <TouchableOpacity
              ...
              onPress={() =>
                router.push(
                  '/(tabs)/screens/primary_school_students/skills_reading_class2students/readingpronunciation_bai5_week3' as any
                )
              }
            >
              <Image
          ...
          <TouchableOpacity
              ...
              onPress={() =>
                router.push(
                  '/(tabs)/screens/primary_school_students/skills_reading_class2students/readingpronunciation_bai6_week3' as any
                )
              }
            >
              <Image
