      ...
      <View style={styles.questionSection}>
          ...
          {showAnswer1 && (
            <View style={styles.answerBox}>
              <Text style={styles.answerContent}>
                Suốt ba tháng hè, cái trống cũng được nghỉ, nằm im lìm trên giá ngẫm nghĩ vì vắng bóng các bạn học sinh.
              </Text>
        ...
        <View style={styles.questionBlock}>
          ...
          {showAnswer2 && (
            <View style={styles.answerBox}>
              <Text style={styles.answerContent}>
                Thấy các bạn học sinh quay trở lại, trống rất mừng vui và cất giọng "Tùng! Tùng! Tùng! Tùng!" rộn rã tưng bừng.
              </Text>
        ...
        <View style={styles.questionBlock}>
          ...
          <View style={styles.questionBox}>
            <Text style={styles.questionText}>
              Bài thơ thể hiện tình cảm của bạn nhỏ với cái trống trường như thế nào?
            </Text>
          </View>
          ...
          {showAnswer3 && (
            <View style={styles.answerBox}>
              <Text style={styles.answerContent}>
                Bạn nhỏ coi cái trống như một người bạn thân thiết, luôn thấu hiểu, gắn bó và cùng sẻ chia niềm vui đến trường.
              </Text>
